...
if [[ "$ENABLE_GPU" == "true" ]]; then
    ...
    VLLM_SERVE_ARGS="-c,import torch.ops; setattr(getattr(torch.ops, '_C', type('C', (), {})()), 'init_cpu_memory_env', lambda *a, **k: None); from vllm.entrypoints.cli.main import main; main(),serve,/mnt/models/${MODEL_SUBDIR},--served-model-name=${SERVED_MODEL_NAME},--max-model-len=${MAX_MODEL_LEN},--api-key=${VLLM_API_KEY},--port=8080,--dtype=float32,--enforce-eager"
